 ...
 */
public class GPSActivity extends ActionBarActivity implements
        ConnectionCallbacks, OnConnectionFailedListener {

	private TodoDataSource datasource;
    protected static final String TAG = "gps-activity";
    ...
    public void onCreate(Bundle savedInstanceState) {
    	...
    	editTodo = datasource.find(id);
    	
        mResultReceiver = new AddressResultReceiver(new Handler());

        mLocationAddressTextView = (TextView) findViewById(R.id.lblLocation);
        mProgressBar = (ProgressBar) findViewById(R.id.progress_bar);
        mFetchAddressButton = (Button) findViewById(R.id.btnShowLocation);
    ...
    class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
			...
			editTodo.setLocation(mAddressOutput);
        	datasource.saveTodo(editTodo);
            // Reset. Enable the Fetch Address button and stop showing the progress bar.
            mAddressRequested = false;
            updateUIWidgets();
            Intent i = new Intent(GPSActivity.this, TodoDetailActivity.class);
        	i.putExtra("ID", editTodo.getId());
			startActivity(i);
        }
    }
}